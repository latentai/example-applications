...
TVM_TENSORRT_CACHE_DIR=$INT8_PACKAGE/trt-cache TVM_TENSORRT_USE_INT8=1 TRT_INT8_PATH=~/.latentai/LRE/.model/.activations/ python3 infer.py --lre_object $INT8_PACKAGE --input_image ../../../sample_images/bus.jpg --labels ../../../labels/coco.txt
