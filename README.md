...
- Detectors
    ...
    - MobilenetSSD     [C++](detectors/mobilenet_ssd/cpp_inference/README.md) |  [C++ no torchvision](detectors/mobilenet_ssd/cpp_inference_no_torchvision/README.md) | [python](detectors/mobilenet_ssd/python_inference/README.md)
    - EfficientDet     [C++](detectors/efficientdet/cpp_inference/README.md) | [python](detectors/efficientdet/python_inference/README.md)
